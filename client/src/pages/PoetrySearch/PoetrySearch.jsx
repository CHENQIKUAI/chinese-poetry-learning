...
class PoetrySearch extends Component {
    ...
    handlePageChange = (current, pageSize) => {
        const { title, dynasty, writer, content, type } = this.state;
        this.fetchPoetryList(current, pageSize, { title, dynasty, writer, content, type });
    }
